...
class GeminiService:
    ...
    def get_video_models(self):
        ...
        return [
            ...
            {"separator": True, "label": "── Seedance 2.5 ──"},
            {"name": "seedance_25",        "price": "🖼🆕 Seedance 2.5 I2V · ~$0.09/s (price unverified)"},
            {"name": "seedance_25_t2v",    "price": "📝🆕 Seedance 2.5 T2V · ~$0.09/s (price unverified)"},
            {"name": "seedance_25_ref",    "price": "🎭🆕 Seedance 2.5 Ref · ~$0.09/s (price unverified)"},
